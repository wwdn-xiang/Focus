...
tf.app.flags.DEFINE_string('image_folder',
                           '/2_data/share/workspace/xxh/HE/HE_DATA_135_Finished/2.5x_5x/DATASET/images',
                           'Folder containing images.')

tf.app.flags.DEFINE_string(
    'semantic_segmentation_folder',
    '/2_data/share/workspace/xxh/HE/HE_DATA_135_Finished/2.5x_5x/DATASET/mask_for_train',
...
def _convert_dataset(dataset_split):
    ...
    Args:
      dataset_split: The dataset split (e.g., train_checkpoint, test).

    Raises:
      RuntimeError: If loaded image and label have different shape.
    """
    print(os.path.basename(dataset_split))
